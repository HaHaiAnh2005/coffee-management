        ...
        <div className="flex items-center gap-3 border-l border-stone-800/15 pl-4">
          ...
          {user ? (
            <div className="flex items-center gap-2">
              ...
              <Link
                to="/profile"
                className="flex items-center gap-1.5 text-xs font-semibold text-stone-900 hover:opacity-80 bg-white/40 px-2 py-1 rounded-lg border border-stone-900/10"
              >
                {user.avatar ? (
                  <img
                    src={user.avatar}
                    alt={user.name}
                    className="w-5 h-5 rounded-full object-cover border border-amber-800/30"
                  />
                ) : (
                  <FiUser className="w-4 h-4 text-stone-800" />
                )}
