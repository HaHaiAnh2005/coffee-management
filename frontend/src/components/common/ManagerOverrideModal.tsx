...
interface ManagerOverrideModalProps {
  ...
  actionType: 'ITEM_CANCEL' | 'BILL_CANCEL' | 'DISCOUNT_OVERRIDE' | 'PRICE_OVERRIDE' | 'SHIFT_CLOSE_OVERRIDE';
  targetId?: string;
    ...
    <Modal isOpen={isOpen} onClose={onClose} title="" size="md">
      <div className="p-2 space-y-4">
        ...
        <div className="pt-2 border-t border-stone-100 text-[11px] text-stone-500 text-center flex items-center justify-center gap-1">
          <FiKey className="text-amber-500" /> Thao tác sẽ được tự động ghi nhận vào Bảng Nhật ký hoạt động.
        </div>
      </div>
    </Modal>
  );
